      ...
      >
        ...
        <nav className="mt-10">
          ...
          >
            ...
            <span className="mx-3">Câmeras</span>
          </a>
          <a
            className="flex items-center px-6 py-2 mt-4 text-gray-100 bg-gray-700 bg-opacity-25"
            href="#"
          >
            ...
            <span className="mx-3">Usuários</span>
          </a>
                ...
                <table className="min-w-full border border-gray-200 shadow sm:rounded-lg">
                  ...
                  <tbody className="bg-white">
                    <tr>
                      ...
                      <td className="px-6 py-4 text-sm leading-5 text-gray-500 border-b border-gray-200">
                        Owner
                      </td>
                      <td className="px-6 py-4 text-sm font-medium leading-5 text-right border-b border-gray-200">
                        <a
                          href="#"
                    ...
                    {/* Repita o conteúdo do `<tr>` para adicionar mais linhas, ou mapeie dados dinâmicos */}
                  </tbody>
                </table>
              </div>
            </div>
